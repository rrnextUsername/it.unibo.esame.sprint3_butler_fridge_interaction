...
class TestPositiveReply {
  ...
  var frontEndDummy : ActorBasic? = null
	...
	fun queryFoodTest() {
		...
		solveCheckGoal(fridgeDummy!!,"done(queryReply, pasta)")
		delay(3000)
		solveCheckGoal(resource!!,"currentCmd(successAddFood, pasta)")
		solveCheckGoal(resource!!,"done(check, 1)")
		solveCheckGoalFalse(frontEndDummy!!,"missingFood(panzerotto)")
